...
Output: an answer with links, verification dates, applicability limits, and verified law separated from inference, following the canonical language rule in SKILL.md.
